...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@12a8809a
```

```kotlin
Option.functor()
// arrow.core.Instance_arrow_instances_OptionFunctorInstanceKt$functor$1@2c5eb6ce
```

```kotlin
MapK.semigroup<String, Int>(Int.semigroup())
// arrow.data.Instance_arrow_instances_MapKSemigroupInstanceKt$semigroup$1@14e893cf
```

```kotlin
Either.monadError<Throwable>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@1fbc1dca
```

```kotlin
ListK.traverse()
// arrow.data.Instance_arrow_instances_ListKTraverseInstanceKt$traverse$1@5d6e68d5
```
...
ListK.functor()
// arrow.data.Instance_arrow_instances_ListKFunctorInstanceKt$functor$1@3b575a82
```
